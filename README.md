...
- the csv files contain the results of the experiments
- the experiments notebook holds all the experiment code
- the data_analysis notebook is for analysing the experiment data
